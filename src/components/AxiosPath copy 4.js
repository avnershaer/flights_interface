...
if (userDataObject && typeof userDataObject === "object") {
  ...
  // in case where userData is not valid JSON or an object
...
const AxiosPath = axios.create({
  baseURL: "https://avnersite.com/flight_sys_backend/flight_tickets_order_system/",  
